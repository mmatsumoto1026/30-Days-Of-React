...
/* Exercises: Level 1
  ...
  How do you implement conditional rendering?
    - We can implement conditional rendering using regular if and else statement, ternary operator and &&. Let's implement a different conditional rendering.

  Which method of conditional rendering do you prefer to use?
    - I like each method of conditional rendering because each method has suitable usage situations for readability, cleaness and rythm of code.
 */